    ...
    render(){
        return(
            ...
            <div className="w-container">
                <form action="/search" className="w-form"><input type="search" className="w-input" maxLength="256"
                                                                 name="query" placeholder="Search…" id="search"
                                                                 required=""/><input type="submit" value="Search"
                                                                                    className="search-button w-button"/>
                </form>
            </div>
            <div className="content-wrapper"><a href="#" className="link-block w-inline-block"/>
